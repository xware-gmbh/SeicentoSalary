...
import ch.xwr.seicentobookit.business.TheVersion;
...
public class UserInfoPopup extends XdevView {
	 ...
	 */
	private void gridLayoutUsr_attach(ClientConnector.AttachEvent event) {
	 ...
	 * @eventHandlerDelegate Do NOT delete, used by UI designer!
	 */
	private void gridLayoutApp_attach(ClientConnector.AttachEvent event) {
		Locale currentLocale = Locale.getDefault();
		labelCountry.setValue(currentLocale.getDisplayCountry());
		labelLanguage.setValue(currentLocale.getDisplayLanguage());
		
		Calendar cal = Calendar.getInstance();
		labelTimeZone.setValue(cal.getTimeZone().getID());
	}
	...
	private void initUI() {
		...
		this.gridLayoutApp.addComponent(gridLayoutApp_hSpacer, 2, 0, 2, 4);
		...
		this.gridLayoutApp.addComponent(gridLayoutApp_vSpacer, 0, 5, 1, 5);
		this.gridLayoutApp.setRowExpandRatio(5, 1.0F);
